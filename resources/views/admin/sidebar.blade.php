		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<span class="title">لوحة إعلانات</span>
					<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li>
					...
					<span class="title">إضافة إعلان  </span>
					<span class="arrow "></span>
					</a>
					{{-- <ul class="sub-menu">
						<li>
				...
				<li>
					<a href="javascript:;">
					<i class="icon-puzzle"></i>
					<span class="title">حجوزات عقاري</span>
					<span class="arrow "></span>
					</a>
				</li>
					<li>
					...
					<a href="javascript:;">
					<i class="icon-puzzle"></i>
					<span class="title">تسديد المستحقات </span>
					<span class="arrow "></span>
					</a>
				</li>
                </li>
					...
					<a href="javascript:;">
					<i class="icon-puzzle"></i>
					<span class="title">حظر مستخدم/معلن </span>
					<span class="arrow "></span>
					</a>
					{{-- <ul class="sub-menu">
						<li>
					...
					<a href="javascript:;">
					<i class="icon-puzzle"></i>
					<span class="title">عدد ساعات العمل للعاملين </span>
					<span class="arrow "></span>
					</a>
				</li>
				<li>
